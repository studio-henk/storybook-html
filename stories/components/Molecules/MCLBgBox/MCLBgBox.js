...
export const createMCLBgBox = ({
    ...
    // set style attribute
    if (bgColor && !fgColor) {
        mclBgBox.setAttribute('style', '--color-background-component-bgbox:' + bgColor + ';');
    } else if (!bgColor && fgColor) {
        mclBgBox.setAttribute('style', '--color-text-component-bgbox:' + fgColor + ';');
    } else if (bgColor && fgColor) {
        mclBgBox.setAttribute('style', '--color-background-component-bgbox:' + bgColor + '; --color-text-component-bgbox:' + fgColor + ';');
    }
