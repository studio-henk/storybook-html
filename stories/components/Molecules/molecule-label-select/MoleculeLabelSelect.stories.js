import {createMoleculeLabelSelect} from './MoleculeLabelSelect';
import {BADGE} from '@geometricpanda/storybook-addon-badges';

export default {
    title: 'Components/Molecules/Input Controls/Label + Select',
    parameters: {
...
const Template = ({labelText, ...args}) => {
    return createMoleculeLabelSelect({labelText, ...args});
};
